...
var Goals = {
  ...
  init: function init(containerElement) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.container).on("click", ".isp-goals__button", function (e) {
      e.preventDefault();
  ...
  setupAccordionToggle: function setupAccordionToggle() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.container).on("click", ".isp-goals__toggle", function (e) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest(".isp-goals__slide").toggleClass("is-goal--open").find(".isp-goals__body").slideToggle();
    });
  }
};
