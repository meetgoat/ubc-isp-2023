...
<div class="wp-block-group isp-callout-block isp-callout-block--lined has-isp-sand-2-background-color has-background">
	...
	<h2
		class="wp-block-heading has-text-align-center is-style-sub-heading has-isp-calcite-color has-text-color has-small-font-size"
		style="text-transform:uppercase">Funding Streams</h2>
	<!-- /wp:heading -->
	<!-- wp:heading {"textAlign":"center","textColor":"isp-bistre","fontSize":"medium"} -->
	<h2 class="wp-block-heading has-text-align-center has-isp-bistre-color has-text-color has-medium-font-size">Indigenous
		Strategic Initiatives funding <br>is allocated across three streams.</h2>
	<!-- /wp:heading -->
