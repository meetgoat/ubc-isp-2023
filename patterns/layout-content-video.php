 ...
 * Slug: meetgoat/layout-content-video
	...
	<div class="wp-block-group isp-background__content" style="margin-top:0;margin-bottom:0"><!-- wp:columns -->
		<div class="wp-block-columns"><!-- wp:column {"width":"35%","className":"isp-mobile-order--2"} -->
			<div class="wp-block-column isp-mobile-order--2" style="flex-basis:35%">
				...
				<!-- wp:heading {"textColor":"isp-bistre","fontSize":"large"} -->
				<h2 class="wp-block-heading has-isp-bistre-color has-text-color has-large-font-size">Leading the
					advancement of Indigenous peoples’ human rights.</h2>
				<!-- /wp:heading -->
				...
				<p class="has-isp-bistre-color has-text-color">UBC’s 2020 Indigenous Strategic Plan outlines eight goals
					and 43 actions the university will collectively take to advance its vision of UBC as a leading
					university globally in the implementation of Indigenous peoples’ human rights.</p>
				<!-- /wp:paragraph -->
			...
			<!-- wp:column {"width":"24px","className":"isp-desktop-only"} -->
			...
			<div class="wp-block-column isp-mobile-order--1">
				...
				<div class="wp-block-group isp-video"
					...
					<!-- wp:video {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
					<figure class="wp-block-video"
						style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><video controls
