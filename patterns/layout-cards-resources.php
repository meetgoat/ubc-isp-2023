		...
		<div class="wp-block-column" style="flex-basis:66.66%">
			...
			<div class="wp-block-group isp-card__content">
				...
				<div class="wp-block-group isp-card__title">
					...
					<h3 class="wp-block-heading has-isp-calcite-color has-text-color has-large-font-size">Intent to
						Action Tool</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group isp-card__text"><!-- wp:paragraph {"fontSize":"medium"} -->
					<p class="has-medium-font-size">The Intent to Action Tool provides a structure for units to review
						...
						contribute to implementing your goals through some specific selected activities. This tool is
						made up of a Facilitator’s Guide and Workshop Slides.</p>
					<!-- /wp:paragraph -->

					<!-- wp:buttons -->
					<div class="wp-block-buttons"><!-- wp:button -->
						<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Facilitator’s
								Guide<img class="wp-image-383" style="width: 32px;"
									src="/wp-content/themes/ubc-isp/patterns/images/pdf.png" alt=""></a></div>
						<!-- /wp:button -->

						<!-- wp:button -->
						<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Workshop Slides
								<img class="wp-image-383" style="width: 32px;"
									src="/wp-content/themes/ubc-isp/patterns/images/pdf.png" alt=""></a></div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
		...
		<div class="wp-block-column" style="flex-basis:33.33%">
			...
			<div class="wp-block-group isp-card__image">
				...
				<figure class="wp-block-image size-full"><img
						src="http://ubcisp.local/wp-content/uploads/2023/06/unsplash_2gVMzOUryMY.png" alt=""
