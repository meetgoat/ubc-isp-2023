...
<div class="wp-block-group"><!-- wp:columns -->
	<div class="wp-block-columns"><!-- wp:column {"width":"25%"} -->
		<div class="wp-block-column" style="flex-basis:25%">
			...
			<h2 class="wp-block-heading has-isp-calcite-color has-text-color has-large-font-size">Frequently <br>Asked
				<br>Questions</h2>
			<!-- /wp:heading -->
			...
			<div class="wp-block-group isp-accordion">
				...
				<div class="wp-block-group isp-accordion--single">
					...
					<div class="wp-block-group isp-accordion--body"><!-- wp:paragraph -->
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed haec quidem liberius ab eo dicuntur et
							saepius. Duo Reges: constructio interrete. Sint ista Graecorum; Expectoque quid ad id, quod quaerebam,
							respondeas. Et ille ridens: Video, inquit, quid agas; Quis suae urbis conservatorem Codrum, quis Erechthei
							filias non maxime laudat?</p>
						<!-- /wp:paragraph -->
